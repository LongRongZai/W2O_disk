...
public class Swagger2Config {
    ...
    public Swagger2Config(DiskProperties diskProperties) {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.small.web.disk.controller"))// 指定api路径
    ...
    private List<SecurityContext> securityContexts() {
        ...
        builder.forPaths(forExcludeAntPaths(diskProperties.getLoginInterceptorExcludePath()));
